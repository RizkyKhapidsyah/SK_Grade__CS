...
namespace SK_Grade__CS
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Write(" Nilai Absen  : "); nabsen = Console.ReadLine();
            Console.Write(" Nilai Tugas  : "); ntugas = Console.ReadLine();
            Console.Write(" Nilai UTS    : "); nuts = Console.ReadLine();
            Console.Write(" Nilai UAS    : "); nuas = Console.ReadLine();
